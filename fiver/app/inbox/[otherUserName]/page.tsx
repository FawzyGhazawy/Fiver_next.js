    ...
    useEffect(() => {
        const callMutation = async () => {
            try {
                ...
                setConversation({
                    _id: result.conversation?._id as Id<"conversations">,
                    _creationTime: result.conversation?._creationTime ?? 0,
                    participantOneId: result.currentUser._id,
                    participantTwoId: result.otherUser._id,
                });
            } catch (error) {
