...
const Edit = ({ params }: EditGigProps) => {
    ...
    //Undefined means it's still retrieving data from the server.
    if(gig === undefined || published === undefined){
        return null;
    }

    if(gig === null){
        return <div>Gig with id ${gig} Not found</div>;
    }
         ...
         <>
             <div className="space-y-12 2xl:px-64 xl:px-36 md:px-12 px-12">
                 ...
                 <div className="flex rounded-md border border-zinc-300 items-center space-x-4 w-fit p-2 cursor-default">
                     <p className="text-muted-foreground">👨‍🎨 Creator: {"Fawzy Ghazawy"}</p>
                 </div>
